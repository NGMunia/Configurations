...
#SNMP configuration:
with open("C:\\Users\\Munia-Virtual\\Desktop\\Scripts\\Configurations\\Project 1\\SNMP.txt","w") as f:
...
with open("C:\\Users\\Munia-Virtual\\Desktop\\Scripts\\Configurations\\Project 1\\SNMP.txt","r") as f:
    read_data=f.read()
    print(read_data)
